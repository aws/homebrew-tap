...
class AwsSamCliBetaCdk < Formula
  include Language::Python::Virtualenv

  config_provider = ConfigProvider.new("aws-sam-cli-beta-cdk")
  ...
  head "https://github.com/aws/aws-sam-cli.git", branch: "cdk-support"
  ...
  def install
    ...
    system libexec/"bin/pip", "install", "--no-use-pep517", "-v", "--pre", "--ignore-installed", buildpath
  ...
  test do
    assert_match "Usage", shell_output("#{bin}/sam-beta-cdk --help")
  end
end
