...
class AwsSamCliBetaAcc < Formula
  include Language::Python::Virtualenv

  config_provider = ConfigProvider.new("aws-sam-cli-beta-acc")
  ...
  head "https://github.com/aws/aws-sam-cli.git", branch: "accelerate"
  ...
  test do
    assert_match "Usage", shell_output("#{bin}/sam-acc --help")
  end
end
